...
public: 
	...
	virtual void PreloadInstanceResources(Legacy::Vec3 vPrevPortalPos, float fPrevPortalDistance, float fTime);
...
protected:
	...
	void	WakeupPhys( );
	bool	AnglesToLimit( Legacy::Vec3& angl);
	void	UpdateWeaponLimitRotation( Legacy::Vec3& curPos, bool bClamped);
	...
	Legacy::Vec3	m_vWpnPos;
	Legacy::Vec3	m_vWpnAng;
	Legacy::Vec3	m_vWpnAngNoSnap;
	Legacy::Vec3	m_vWpnAngDelta;
	Legacy::Vec3	m_vCross3D;
	Legacy::Vec3	m_vCrossScreen;
	Legacy::Vec3	m_vCrossScreenSmoothed;
	bool	m_bTargetIsLocked;
	bool	m_bCrossOnScreen;

	// inertial camera stuff
	Legacy::Vec3 m_vPrevCamTarget;
	Legacy::Vec3 m_vCamPos,m_vCamVel;
	Legacy::Vec3 m_vCamHelperPos;
	Legacy::Vec3 m_vCamStiffness[2];
	Legacy::Vec3 m_vCamLimits[2];
	float m_fCamDamping;
