...
{
  public:
	CCVar(const char* name, int value, char* help)
		: name(name)
		, value(value)
		, type(CVAR_INT)
		, help(help)
	...
	CCVar(const char* name, const char* value, char* help)
		: name(name)
		, value(value)
		, type(CVAR_STRING)
		, help(help)
	...
	CCVar(const char* name, float value, char* help)
		: name(name)
		, value(value)
		, type(CVAR_FLOAT)
		, help(help)
...
{
  public:
	CCVarRef(const char* name, int* value, const char* help)
		: name(name)
		, value(value)
		, type(CVAR_INT)
		, help(help)
	...
	CCVarRef(const char* name, const char** value, const char* help)
		: name(name)
		, value(value)
		, type(CVAR_STRING)
		, help(help)
	...
	CCVarRef(const char* name, float* value, const char* help)
		: name(name)
		, value(value)
		, type(CVAR_FLOAT)
		, help(help)
