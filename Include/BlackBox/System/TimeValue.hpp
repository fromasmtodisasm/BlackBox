...
public:
	...
	//! Binary subtraction.
	ILINE CTimeValue operator-(const CTimeValue& inRhs) const
	{
		CTimeValue ret;
	...
	//! Sign inversion.
	ILINE CTimeValue operator-() const
	{
		CTimeValue ret;
	...
	ILINE CTimeValue& operator/=(int inRhs)
	{
		m_lValue /= inRhs;
		return *this;
	}
	...
	void       GetMemoryStatistics(struct ICrySizer* pSizer) const
	{ /*nothing*/
	}
