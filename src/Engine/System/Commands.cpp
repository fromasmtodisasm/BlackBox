...
#endif
//*******************************************************
class ShaderCommand : public SystemCommand
	, public IMaterialShaderSink
{
	IWorld* m_World;
...
ShaderCommand::ShaderCommand(ISystem* pSystem)
	: SystemCommand(pSystem)
{
