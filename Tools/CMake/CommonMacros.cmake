...
macro(add_sources name)
	...
	foreach(ARG ${ARGN})
		...
		elseif(EXPECTING_FILE)
			...
			if((NOT ${CURRENT_SOURCE_GROUP} STREQUAL "Root") AND (NOT ${NOT_FORM_PROPS}))
...
function(EditorPlugin target)
	...
	set_property(TARGET ${THIS_PROJECT} PROPERTY LIBRARY_OUTPUT_DIRECTORY_DEBUG "${CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELEASE}/EditorPlugins")
