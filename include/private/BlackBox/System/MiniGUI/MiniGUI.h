...
#include <BlackBox/System/IMiniGUI.hpp>
...
class CMiniCtrl : public IMiniCtrl
{
  public:
	...
	virtual void SetGUI(IMiniGUI* pGUI)
	{
		m_pGUI = pGUI;
	};
	virtual IMiniGUI* GetGUI() const
	{
		return m_pGUI;
	};
	...
	virtual void SetFlag(uint32 flag)
	{
		set_flag(flag);
	}
	virtual void ClearFlag(uint32 flag)
	{
		clear_flag(flag);
	};
	virtual bool CheckFlag(uint32 flag) const
	{
		return is_flag(flag);
	}
	...
	virtual IMiniCtrl* GetParent() const
	{
		return m_pParent;
	};
	...
	virtual bool SetRenderCallback(RenderCallback callback)
	{
  ...
  protected:
	...
	bool is_flag(uint32 flag) const
	{
...
//////////////////////////////////////////////////////////////////////////
class CMiniGUI : public IMiniGUI
