...
class CBaseInput : public IInput
	, public ISystemEventListener
{
  public:
	...
	virtual uint32_t GetPlatformFlags() const
	{
		return m_platformFlags;
	}
	...
	virtual int ShowCursor(const bool bShow)
	{
		return 0;
	}
