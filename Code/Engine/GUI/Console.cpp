...
struct ImGuiConsole : public IOutputPrintSink
{
    char                  InputBuf[256];
    ImVector<char*>       Items;
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        for (int i = 0; i < Items.Size; i++)
        {
			...
			c							   = text.data();
			const char* begin_chunk = c; const char* end_chunk = c;
...
//1.f,0.f,255.f,0.f
			...
			for (auto& chunk : chunks)
			{
                ...
                ImGui::TextUnformatted(chunk.str.data(), chunk.str.data() + chunk.str.length()); ImGui::SameLine(0, 0);
                ImGui::PopStyleColor();
            }
