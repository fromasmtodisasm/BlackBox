...
struct IEntityRender
{
  ...
  void SetViewDistRatio(int nViewDistRatio) { ucViewDistRatio = std::min(254,std::max(0,nViewDistRatio)); }
  ...
  void SetLodRatio(int nLodRatio) { ucLodRatio = std::min(255,std::max(0,nLodRatio)); }
