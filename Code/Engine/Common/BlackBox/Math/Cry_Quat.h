...
struct Quaternion_tpl
{
	...
	explicit ILINE Quaternion_tpl(const Matrix33_tpl<F1, SI, SJ>& m)
	{
	...
	template<class T>
	ILINE Quaternion_tpl(const Quaternion_tpl<T>& q)
	{
		w   = q.w;
		v.x = q.v.x;
		v.y = q.v.y;
	...
	//double=f32
	template<typename U>
	ILINE Quaternion_tpl& operator=(const U& q)
	{
		w   = (F)q.w;
		v.x = (F)q.v.x;
		v.y = (F)q.v.y;
...
*/
template<class F>
ILINE Quaternion_tpl<F>::Quaternion_tpl(const F angle, const Vec3_tpl<F>& axis)
{
	w = angle;
	v = axis;
}
...
*/
template<class F>
ILINE Quaternion_tpl<F> Quaternion_tpl<F>::operator!() const
{
#if !defined(LINUX)
...
template<class F>
ILINE void Quaternion_tpl<F>::Invert(void)
{
	*this = !*this;
}
template<class F>
ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetInverted(Quaternion_tpl<F>& q)
{
	return !q;
}
template<class F>
ILINE Quaternion_tpl<F> GetInverted(Quaternion_tpl<F>& q)
{
	return !q;
}
 ...
 */
template<class F>
ILINE void Quaternion_tpl<F>::SetRotationAA(F rad, const Vec3_tpl<F>& axis)
{
	F cs[2];
...
template<class F>
ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetRotationAA(F rad, const Vec3_tpl<F>& axis)
{
	Quaternion_tpl<F> q;
...
template<class F>
ILINE Quaternion_tpl<F> GetRotationAA(F rad, const Vec3_tpl<F>& axis)
{
	Quaternion_tpl<F> q;
	q.SetRotationAA(rad, axis);
	return q;
...
template<class F>
ILINE void Quaternion_tpl<F>::SetRotationAA(F cosha, F sinha, const Vec3_tpl<F>& axis)
{
#if !defined(LINUX)
...
template<class F>
ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetRotationAA(F cosha, F sinha, const Vec3_tpl<F>& axis)
{
	Quaternion_tpl<F> q;
...
template<class F>
ILINE Quaternion_tpl<F> GetRotationAA(F cosha, F sinha, const Vec3_tpl<F>& axis)
{
	Quaternion_tpl<F> q;
	q.SetRotationAA(cosha, sinha, axis);
	return q;
...
template<class F>
ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetRotationV0V1(const Vec3_tpl<F>& v0, const Vec3_tpl<F>& v1)
{
	Quaternion_tpl<F> q;
...
template<class F>
ILINE Quaternion_tpl<F> GetRotationV0V1(const Vec3_tpl<F>& v0, const Vec3_tpl<F>& v1)
{
	Quaternion_tpl<F> q;
	q.SetRotationV0V1(v0, v1);
	return q;
...
template<class F>
ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetRotationXYZ(const Ang3& a)
{
	Quaternion_tpl<F> q;
	q.SetRotationXYZ(a);
	return q;
...
template<class F>
ILINE Quaternion_tpl<F> GetRotationXYZ(const Ang3& a)
{
	Quaternion_tpl<F> q;
	q.SetRotationXYZ(a);
	return q;
 ...
 */
template<class F>
ILINE void Quaternion_tpl<F>::SetIdentity(void)
{
	w   = 1;
	v.x = 0, v.y = 0;
	v.z = 0;
...
template<class F>
ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetIdentity(void)
{
	return Quaternion_tpl(1, 0, 0, 0);
}
template<class F>
ILINE Quaternion_tpl<F> GetIdentity(void)
{
...
template<class F>
ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetNormalized(const Quaternion_tpl<F>& q)
{
...
template<class F>
ILINE Quaternion_tpl<F> GetNormalized(const Quaternion_tpl<F>& q)
{
	Quaternion_tpl<F> t = q;
	t.Normalize();
	return t;
...
*/
template<class F>
ILINE F Quaternion_tpl<F>::GetLength(const Quaternion_tpl<F>& q)
{
	return sqrt_tpl(q | q);
}
template<class F>
ILINE F GetLength(const Quaternion_tpl<F>& q)
{
	return sqrt_tpl(q | q);
}
