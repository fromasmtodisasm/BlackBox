...
void CVehicle::UpdateParaglider(float fTimeStep)
{
	...
	auto	angle = m_pEntity->GetAngles();
	pe_action_impulse am;
	Matrix44	m;
	Vec3		boatUp=Vec3(0.0f,0.0f,1.0f);
	Vec3		boatFwd=Vec3(0.0f,-1.0f,0.0f);
...
//////////////////////////////////////////////////////////////////////////
void CVehicle::PreloadInstanceResources(Vec3 vPrevPortalPos, float fPrevPortalDistance, float fTime)
{
...
void	CVehicle::UpdateLights( )
{
	...
	if(m_bHeadLightsOn)
	{
		if(m_pHeadLight)
		{
			...
			m_pHeadLight->m_ProjAngles = Vec3(m_pEntity->GetAngles().y,m_pEntity->GetAngles().x,m_pEntity->GetAngles().z+90);
...
void	CVehicle::UpdateFakeLight( CDLight* light, const char* sHelper )
{
	...
	light->m_ProjAngles = Vec3(m_pEntity->GetAngles().y,m_pEntity->GetAngles().x,m_pEntity->GetAngles().z+90);
...
//////////////////////////////////////////////////////////////////////////
void CVehicle::GetFirePosAngles(Vec3& firePos, Vec3& fireAngles)
{
	firePos = m_vWpnPos;
...
void CVehicle::AdditionalPhysics(IPhysicalEntity *pcar,float fdelta,bool bforcebreaking)
{
	...
	else if (m_fstabilizejump>0) // flying? try to stabilize the rolling		
	{
		...
		Vec3 vUpDir = GetTransposed44(tm)*Vec3(0,0,1);
		Vec3 vFwdDir = GetTransposed44(tm)*Vec3(0,-1,0);
		...
		if (vUpDir.z > 0.5f) 
		{
			...
			Vec3 vert = GetTransposed44(tm)*Vec3(0,0,1);
...
//////////////////////////////////////////////////////////////////////////
void CVehicle::OnEntityNetworkUpdate( const EntityId &idViewerEntity, const Vec3 &v3dViewer, uint32 &inoutPriority, 
