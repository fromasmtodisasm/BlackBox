...
struct Matrix33diag_tpl
{
	...
	template<class F1>
	Matrix33diag_tpl& operator=(const Matrix33diag_tpl<F1>& src)
	{
		x = src.x;
		y = src.y;
		z = src.z;
	...
	template<class F1>
	const Matrix33diag_tpl& operator=(const Vec3_tpl<F1>& src)
	{
		x = src.x;
		y = src.y;
		z = src.z;
...
template<class F, int SI, int SJ>
ILINE Matrix33_tpl<F, SI, SJ> operator/(const Matrix33_tpl<F, SI, SJ>& src, F op)
{
	return src * ((F)1.0 / op);
}
...
template<class F>
ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateIdentity(void)
{
	Matrix34_tpl<F> m34;
	m34.SetIdentity();
	return m34;
...
//////////////////////////////////////////////////////////////////////
template<class F>
ILINE void Matrix34_tpl<F>::SetTranslation(const Vec3_tpl<F>& t)
{
	m03 = t.x;
	m13 = t.y;
	m23 = t.z;
...
//////////////////////////////////////////////////////////////////////
template<class F>
ILINE Vec3_tpl<F> Matrix34_tpl<F>::GetTranslation() const
{
...
template<class F>
ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationAA(const F rad, const Vec3_tpl<F>& axis, const Vec3_tpl<F>& t)
{
	Matrix34_tpl<F> m34;
...
template<class F>
ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationX(const f32 rad, const Vec3_tpl<F>& t)
{
	Matrix34_tpl<F> m34;
...
template<class F>
ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationY(const f32 rad, const Vec3_tpl<F>& t)
{
	Matrix34_tpl<F> m34;
...
template<class F>
ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationZ(const f32 rad, const Vec3_tpl<F>& t)
{
	Matrix34_tpl<F> m34;
...
template<class F>
ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateRotationXYZ(const Ang3_tpl<F>& rad, const Vec3_tpl<F>& t)
{
	Matrix34_tpl<F> m34;
...
*/
template<class F>
ILINE Matrix34_tpl<F> Matrix34_tpl<F>::CreateScale(const Vec3_tpl<F>& s, const Vec3_tpl<F>& t)
{
	Matrix34_tpl<F> m34;
	m34.SetScale(s, t);
	return m34;
...
template<class F>
ILINE Matrix34_tpl<F> Matrix34_tpl<F>::GetInverted()
{
