...
STRUCT_INFO_BEGIN(ZipFile::CentralDirectory)
VAR_INFO(lSignature)
...
STRUCT_INFO_END(ZipFile::CentralDirectory)
...
STRUCT_INFO_BEGIN(ZipFile::SPakFileVersion)
VAR_INFO(version)
STRUCT_INFO_END(ZipFile::SPakFileVersion)
