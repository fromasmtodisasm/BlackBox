...
template<class F>
inline F sqr(const F& op)
{
	return op * op;
}

template<class F>
inline F cube(const F& op)
{
	return op * op * op;
}
template<class F>
inline F sqr_signed(const F& op)
{
...
//////////////////////////////////////////////////////////////////////
template<class F>
int inrange(F x, F end1, F end2)
{
	return isneg(fabs_tpl(end1 + end2 - x * (F)2) - fabs_tpl(end1 - end2));
}

template<class F>
F cond_select(int bFirst, F op1, F op2)
{
	F arg[2] = {op1, op2};
	return arg[bFirst ^ 1];
}
...
public:
	...
	template<class ref>
	unused_marker& operator,(ref*& x)
	{
		x = (ref*)-1;
		return *this;
	}
	template<class F>
	unused_marker& operator,(Vec3_tpl<F>& x)
	{
		return *this, x.x;
	}
	template<class F>
	unused_marker& operator,(Quaternion_tpl<F>& x)
	{
		return *this, x.w;
	}
};
...
template<class ref>
bool is_unused(ref* x)
{
	return x == (ref*)-1;
}
template<class F>
bool is_unused(const Vec3_tpl<F>& x)
{
	return is_unused(x.x);
}
template<class F>
bool is_unused(const Quaternion_tpl<F>& x)
{
...
public:
	...
	template<class dtype1>
	strided_pointer& operator=(const strided_pointer<dtype1>& src)
	{
		data    = src.data;
		iStride = src.iStride;
		return *this;
...
//////////////////////////////////////////////////////////////////////
template<class F>
int intersect_lists(F* pSrc0, int nSrc0, F* pSrc1, int nSrc1, F* pDst)
{
	int i0, i1, n;
	F   ares;
