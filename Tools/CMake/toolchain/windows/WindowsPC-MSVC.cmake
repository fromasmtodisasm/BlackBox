...
set(_FLAGS "")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} /EHsc ${_FLAGS}" CACHE STRING "C++ Common Flags" FORCE)
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /EHsc ${_FLAGS}" CACHE STRING "C++ Common Flags" FORCE)
