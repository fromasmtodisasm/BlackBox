...
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} /MD" CACHE STRING "C Flags" FORCE)
set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /MD" CACHE STRING "C++ Flags" FORCE)

#set(CMAKE_C_FLAGS_RELEASE "${MSVC_COMMON_FLAGS} /Zo /Ox /MT /GS- /DNDEBUG /D_RELEASE" CACHE STRING "C Flags" FORCE)
#set(CMAKE_CXX_FLAGS_RELEASE "${MSVC_COMMON_FLAGS} /Zo /Ox /MT /GS- /DNDEBUG /D_RELEASE" CACHE STRING "C++ Flags" FORCE)

#if (OPTION_STATIC_LINKING)
#	set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} /MT" CACHE STRING "C Flags" FORCE)
#else()
#	set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} /MD" CACHE STRING "C Flags" FORCE)
#endif()
