	...
	GUI =
	{
		...
		reset =
		{
			...
			OnCommand = function(Sender)
				UI.YesNoBox(Localize("ResetToDefault"), Localize("GenericAreYouSure"),
					UI.PageOptionsControl.ResetToDefaults);
			end,
		},
		...
		OnActivate = function(Sender)
			...
			UI.PageOptionsControl.GUI.controllist:AddColumn(Localize("CtrlActionName"), 270, UIALIGN_RIGHT,
				UI.szListViewOddColor, "0 0 0 0", nil, nil, 0, 0);
			UI.PageOptionsControl.GUI.controllist:AddColumn(Localize("CtrlActionBinding1"), 144, UIALIGN_CENTER,
				UI.szListViewEvenColor, "0 0 0 12");
			UI.PageOptionsControl.GUI.controllist:AddColumn(Localize("CtrlActionBinding2"), 144, UIALIGN_CENTER,
				UI.szListViewOddColor, "0 0 0 0");
...
function UI.PageOptionsControl.FillBindList()
	...
	for szType, Map in pairs(ActionMap) do
		...
		for i, szActionName in ipairs(MapOrder) do
