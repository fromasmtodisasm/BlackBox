...
//
////! Compiler version
//#define BB_COMPILER_CLANG   1
//#define BB_COMPILER_VERSION ((__clang_major__ * 100) + (__clang_minor__ * 10))
//#if BB_COMPILER_VERSION < 390
//    #error This version of clang is not supported, the minimum supported version is 3.9 (#BB_COMPILER_VERSION)
//#endif
...
// Suppress undefined behavior sanitizer errors on a function.
	...
	#define BB_FUNCTION_CONTAINS_UNDEFINED_BEHAVIOR __attribute__((no_sanitize("undefined")))
#elif defined(BB_UBSAN) && __has_attribute(no_sanitize_undefined)
	#define BB_FUNCTION_CONTAINS_UNDEFINED_BEHAVIOR __attribute__((no_sanitize_undefined))
#else
