...
void CGame::ResetInputMap()
{
	...
	//-------------------------------------------------------------------------------------------------
	ADD_ACTION(MOVE_LEFT, aamOnHold, "@MoveLeft", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("MOVE_LEFT", ACTIONMAPS_ALL);
	ADD_ACTION(MOVE_RIGHT, aamOnHold, "@MoveRight", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("MOVE_RIGHT", ACTIONMAPS_ALL);
	ADD_ACTION(MOVE_FORWARD, aamOnHold, "@MoveForward", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("MOVE_FORWARD", ACTIONMAPS_NODEAD);
	ADD_ACTION(MOVELR, aamOnHold, "@MoveLeftRight", 0, false)
	SetConfigToActionMap("MOVELR", ACTIONMAPS_NODEAD);
	ADD_ACTION(MOVEFB, aamOnHold, "@MoveFwdBack", 0, false)
	SetConfigToActionMap("MOVEFB", ACTIONMAPS_NODEAD);

	ADD_ACTION(WALK, aamOnHold, "@Walk", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("WALK", ACTIONMAPS_NODEAD);
	ADD_ACTION(RUNSPRINT, aamOnHold, "@SprintRun", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("RUNSPRINT", ACTIONMAPS_NODEAD);

	ADD_ACTION(MESSAGEMODE, aamOnPress, "@Chat", ACTIONTYPE_MULTIPLAYER, true)
	SetConfigToActionMap("MESSAGEMODE", ACTIONMAPS_ALL);
	ADD_ACTION(MESSAGEMODE2, aamOnPress, "@TeamChat", ACTIONTYPE_MULTIPLAYER, true)
	SetConfigToActionMap("MESSAGEMODE2", ACTIONMAPS_ALL);

	//ADD_ACTION(RUN,aamOnDoublePress,"Move Forward2",false) SetConfigToActionMap("RUN", ACTIONMAPS_NODEAD);
	ADD_ACTION(MOVE_BACKWARD, aamOnHold, "@MoveBackward", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("MOVE_BACKWARD", ACTIONMAPS_NODEAD);
	//ADD_ACTION(VEHICLE_BOOST,aamOnDoublePress)
	ADD_ACTION(SCORE_BOARD, aamOnHold, "@ViewScoreboard", ACTIONTYPE_MULTIPLAYER, true)
	SetConfigToActionMap("SCORE_BOARD", ACTIONMAPS_ALL);
	ADD_ACTION(JUMP, aamOnHold, "@Jump", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("JUMP", "default", "binozoom", "vehicle", "");
	ADD_ACTION(MOVEMODE, aamOnHold, "@Crouch", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("MOVEMODE", ACTIONMAPS_NODEAD);
	ADD_ACTION(MOVEMODE2, aamOnPress, "@Prone", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("MOVEMODE2", ACTIONMAPS_NODEAD);
	//	ADD_ACTION(MOVEMODE2,aamOnDoublePress,"Change Movemode",true)
	ADD_ACTION(LEANLEFT, aamOnHold, "@LeanLeft", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("LEANLEFT", "default", "zoom", "binozoom", "");
	ADD_ACTION(LEANRIGHT, aamOnHold, "@LeanRight", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("LEANRIGHT", "default", "zoom", "binozoom", "");
	ADD_ACTION(FIRE0, aamOnHold, "@Fire", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("FIRE0", "default", "zoom", "vehicle", "player_dead", "");
	...
	ADD_ACTION(USE, aamOnPress, "@Use", ACTIONTYPE_GAME, true)
	SetConfigToActionMap("USE", ACTIONMAPS_NODEAD);
	ADD_ACTION(TURNLR, aamOnHold, "@TurnLeftRight", 0, false)
	SetConfigToActionMap("TURNLR", ACTIONMAPS_NODEAD);
	ADD_ACTION(TURNUD, aamOnHold, "@TurnUpDown", 0, false)
	SetConfigToActionMap("TURNUD", ACTIONMAPS_NODEAD);
	//	ADD_ACTION(RUN,aamOnHold,"Toggle Run",true)
	ADD_ACTION(NEXT_WEAPON, aamOnPress, "@NextWeapon", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("NEXT_WEAPON", "default", "");
	ADD_ACTION(PREV_WEAPON, aamOnPress, "@PrevWeapon", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("PREV_WEAPON", "default", "");
	ADD_ACTION(RELOAD, aamOnPress, "@Reload", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("RELOAD", ACTIONMAPS_NODEAD);
	//ADD_ACTION(WEAPON_0,aamOnPress,"@Slot0",ACTIONTYPE_COMBAT,true) SetConfigToActionMap("WEAPON_0", ACTIONMAPS_WEAPON);
	ADD_ACTION(DROPWEAPON, aamOnPress, "@DropWeapon", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("DROPWEAPON", "default", "");
	ADD_ACTION(WEAPON_1, aamOnPress, "@Slot1", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("WEAPON_1", "default", "zoom", "binozoom", "");
	ADD_ACTION(WEAPON_2, aamOnPress, "@Slot2", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("WEAPON_2", "default", "zoom", "binozoom", "");
	ADD_ACTION(WEAPON_3, aamOnPress, "@Slot3", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("WEAPON_3", "default", "zoom", "binozoom", "");
	ADD_ACTION(WEAPON_4, aamOnPress, "@Slot4", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("WEAPON_4", "default", "zoom", "binozoom", "");
  ...
  */
	...
	ADD_ACTION(CYCLE_GRENADE, aamOnPress, "@CycleGrenade", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("CYCLE_GRENADE", ACTIONMAPS_NODEAD);
	...
	ADD_ACTION(ITEM_0, aamOnPress, "@Binoculars", ACTIONTYPE_GAME, true)
	SetConfigToActionMap("ITEM_0", ACTIONMAPS_DEF_ZOOMS);
	ADD_ACTION(ITEM_1, aamOnPress, "@ThermalVision", ACTIONTYPE_GAME, true)
	SetConfigToActionMap("ITEM_1", ACTIONMAPS_NODEAD);
	...
	ADD_ACTION(ZOOM_TOGGLE, aamOnPressAndRelease, "@ToggleZoom", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("ZOOM_TOGGLE", "default", "zoom", "");
	ADD_ACTION(ZOOM_IN, aamOnPress, "@ZoomIn", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("ZOOM_IN", "zoom", "binozoom", "");
	ADD_ACTION(ZOOM_OUT, aamOnPress, "@ZoomOut", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("ZOOM_OUT", "zoom", "binozoom", "");
	ADD_ACTION(HOLDBREATH, aamOnHold, "@HoldBreath", ACTIONTYPE_GAME, true)
	SetConfigToActionMap("HOLDBREATH", "zoom", "");
	ADD_ACTION(FIREMODE, aamOnPress, "@ToggleFiremode", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("FIREMODE", ACTIONMAPS_NODEAD);
	...
	ADD_ACTION(FIRE_GRENADE, aamOnHold, "@ThrowGrenade", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("FIRE_GRENADE", ACTIONMAPS_NODEAD);
	//ADD_ACTION(CONCENTRATION,aamOnHold,"@Concentration",ACTIONTYPE_GAME,true) SetConfigToActionMap("CONCENTRATION", "default", "");
	ADD_ACTION(FLASHLIGHT, aamOnPress, "@ToggleFlashlight", ACTIONTYPE_GAME, true)
	SetConfigToActionMap("FLASHLIGHT", ACTIONMAPS_NODEAD);
	ADD_ACTION(CHANGE_VIEW, aamOnPress, "@SwitchView", ACTIONTYPE_GAME, true)
	SetConfigToActionMap("CHANGE_VIEW", "default", "vehicle", "");
	ADD_ACTION(TAKESCREENSHOT, aamOnPress, "@TakeScreenshot", ACTIONTYPE_GAME, true)
	SetConfigToActionMap("TAKESCREENSHOT", ACTIONMAPS_ALL);

	ADD_ACTION(MOVEMODE_TOGGLE, aamOnPress, "@CrouchToggle", ACTIONTYPE_MOVEMENT, true)
	SetConfigToActionMap("MOVEMODE_TOGGLE", ACTIONMAPS_NODEAD);
	ADD_ACTION(AIM_TOGGLE, aamOnPress, "@ToggleAim", ACTIONTYPE_COMBAT, true)
	SetConfigToActionMap("AIM_TOGGLE", "default", "zoom", "");
