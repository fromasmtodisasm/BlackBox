...
// This header should only be include by Socks.h
#if !defined(INCLUDED_FROM_CRY_SOCKS_H)
	#error "CRYTEK INTERNAL HEADER. Only include from Socks.h."
#endif
//////////////////////////////////////////////////////////////////////////
...
//! \retval <0  An error occurred - see eSocketError.
...
static int select(int nfds, CRYFD_SET* readfds, CRYFD_SET* writefds, CRYFD_SET* exceptfds, CRYTIMEVAL* timeout)
{
	...
	if (nfds == 0)
	{
		CryFatalError("Sock select detected first parameter is 0!  This *MUST* be fixed!");
	}
#endif
