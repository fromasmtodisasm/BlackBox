...
#
 find_path(D3DX11_INCLUDE_DIR d3d11.h
    PATHS
...
set (D3D11_LIBRARIES ${D3D11_LIBRARY} ${D3DX11_LIBRARY})
...
find_package_handle_standard_args(D3D11
  DEFAULT_MSG
  D3D11_LIBRARY D3DX11_LIBRARY D3DX11_INCLUDE_DIR)

mark_as_advanced(D3DX11_INCLUDE_DIR D3D11_LIBRARY D3DX11_LIBRARY)

if(D3D11_FOUND AND NOT TARGET D3D11::D3D11)
  add_library(D3D11::D3D11 UNKNOWN IMPORTED)
  set_target_properties(D3D11::D3D11 PROPERTIES
    IMPORTED_LOCATION "${D3D11_LIBRARIES}"
    INTERFACE_INCLUDE_DIRECTORIES "${D3D11_INCLUDE_DIRS}")
endif()
