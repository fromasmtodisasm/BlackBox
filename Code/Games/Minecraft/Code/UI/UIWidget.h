...
typedef struct UIBorder
{
	UIBorder()
	    ...
	    , iStyle(1)
	    , fSize(0.0f)
	    , cColor(color4f(0.35f, 0.35f, 0.35f, 1.0f)){};
...
typedef struct UIFont
{
	UIFont()
	    : szFaceName("Default")
	    , szEffectName("Default")
	    , fSize(14.0f)
	    , cColor(color4f(1.0f, 1.0f, 1.0f, 1.0f)){};
...
typedef struct UISkinTexture
{
	...
	UISkinTexture(int iTexID)
	    : iTextureID(iTexID)
	    , iOverTextureID(iTexID)
	    , iDownTextureID(iTexID)
	{
#if 1
		vTexCoord[0] = 0;
		vTexCoord[1] = 1;
	...
	UISkinTexture(int iTexID, int iOverTexID, int iDownTexID)
	    : iTextureID(iTexID)
	    , iOverTextureID(iOverTexID)
	    , iDownTextureID(iDownTexID)
	{
#if 1
		vTexCoord[0] = 0;
		vTexCoord[1] = 1;
