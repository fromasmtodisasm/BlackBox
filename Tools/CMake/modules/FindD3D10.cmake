...
set (D3D10_LIBRARIES ${D3D10_LIBRARY} ${D3DX10_LIBRARY})
set (D3D10_INCLUDE_DIRS ${D3DX10_INCLUDE_DIR})


include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(D3D10
  DEFAULT_MSG
  D3D10_LIBRARY D3DX10_LIBRARY D3DX10_INCLUDE_DIR)

mark_as_advanced(D3DX10_INCLUDE_DIR D3D10_LIBRARY D3DX10_LIBRARY)

if(D3D10_FOUND AND NOT TARGET D3D10::D3D10)
  add_library(D3D10::D3D10 UNKNOWN IMPORTED)
  set_target_properties(D3D10::D3D10 PROPERTIES
    IMPORTED_LOCATION "${D3D10_LIBRARIES}"
    INTERFACE_INCLUDE_DIRECTORIES "${D3D10_INCLUDE_DIRS}")
endif()
